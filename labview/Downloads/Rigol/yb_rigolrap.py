...
my_api.ttl_value(SWEEP, 2)
my_api.wait(1)
my_api.ttl_value(SHELVE_CTL | LABVIEW_1762, 2) # Turn on 1762 SPAOM RF switch and signal to LabView that sweep has started
